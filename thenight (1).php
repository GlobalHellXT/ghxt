...
$base_url = 'https://sman1angkolabarat.sch.id/akb/'; // Ganti dengan URL situs utama Anda
...
// Baca daftar folder dari file backup.txt
$daftar_folder = file('backup.txt', FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES);

// Periksa jika file backup.txt berhasil dibaca
if ($daftar_folder === false) {
    die('Gagal membaca file backup.txt');
}
